\chapter*{Teorema de Hanh-Banach y de Mazur-Orlicz}
	...
	\paragraph{} El lema que exponemos a continuación, y que generalizaremos posteriormente en \ref{lema2}, nos servirá para demostrar el teorema de Hanh-Banach. Antes de comenzar, escribiremos $ Q \leq P $ con $ P $ y $ Q $ funcionales lineales sobre \vecSpace si $ Q(x) \leq P(x), \forall x \in \vecSpace $.
