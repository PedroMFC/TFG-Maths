...
%\input{capitulos/HB-MO.tex}
%\input{capitulos/igualdad.tex}
%\input{capitulos/Simons-Gordan}
%\input{capitulos/FJ-KKT}
%\input{capitulos/Minimax}
%\input{capitulos/Separación}
%\input{capitulos/Farkas}
%\input{capitulos/Finanzas}

\input{capitulos/resumen+KW.tex}
\input{capitulos/resumenExt+KW(Eng).tex}
\input{capitulos/Introducción.tex}
\input{capitulos/Objetivos.tex}
\input{capitulos/Desarrollo.tex}\\

\input{capitulos/Intro+M-O-K.tex}
\input{capitulos/Gordan.tex}

\input{capitulos/Intro2+minimax.tex}
\input{capitulos/separación.tex}

\input{capitulos/Intro3+Farkas.tex}
\input{capitulos/programación-lineal.tex}
\input{capitulos/FJ-KKT}

\input{capitulos/Intro4+preliminaresFinanzas.tex}
\input{capitulos/PrimerTeorema.tex}
